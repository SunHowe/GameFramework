...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class SafeAreaChangeEventArgs : GameEventArgs
    {
        ...
        /// 创建事件。
        /// </summary>
        public static SafeAreaChangeEventArgs Create(SafeAreaChangeEventArgs eventArgs)
        {
            var newEventArgs = ReferencePool.Acquire<SafeAreaChangeEventArgs>();
            newEventArgs.SafeArea = eventArgs.SafeArea;
            return newEventArgs;
        }

...
namespace UnityGameFramework.Runtime
{
    ...
    {
        public const string SETTINGS_KEY_LANGUAGE = "Localization.Language";
        ...
        public Language Language
        {
            ...
            set
            {
                ...
                {
                    Log.Error("Not support setting language to unspecified.");
                    return;
                }
                ...
                // 保存语言记录。
                m_SettingComponent.SetInt(SETTINGS_KEY_LANGUAGE, (int) value);
                // 派发事件
                m_EventComponent.Fire(this, LocalizationLanguageUpdateEventArgs.Create(value));
            }
        }
        ...
        private void Start()
        {
            ...
            // 从设置模块读取记录。
            var defaultLanguage = baseComponent.EditorResourceMode && baseComponent.EditorLanguage != Language.Unspecified ? baseComponent.EditorLanguage : m_LocalizationManager.SystemLanguage;
            var settingLanguage = (Language)m_SettingComponent.GetInt(SETTINGS_KEY_LANGUAGE, (int)defaultLanguage);
            m_LocalizationManager.Language = settingLanguage != Language.Unspecified ? settingLanguage : defaultLanguage;
        }
